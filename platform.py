...
#
# This file is a slimmed-down fork of platformio/platform-nxplpc/platform.py
# focused on the Arduino framework + LPC8xx targets. mbed/zephyr-specific
# branches are intentionally removed (use the upstream `nxplpc` platform for
# those).
...
class NxplpcArduinoPlatform(PlatformBase):
    ...
    def configure_debug_session(self, debug_config):
        if debug_config.speed:
            server_executable = (debug_config.server or {}).get(
                "executable", "").lower()
